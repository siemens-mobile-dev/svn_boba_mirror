...
//≈сли S75, расскоментировать сл. строку
#define NEWSGOLD
...
typedef struct
{
  ...
  char unk3;
  char unk4;
  int color1; //ѕараметр GeneralFunc пишетс€ сюда?????
  int color2;
  LLQ item_ll;
  int unk5;
  char unk6;
  ...
  char unk9;
  int unk10;
  int flag30; //»спользуетс€ при создании (бывает |=0x02)
}GUI;
...
__swi __arm int str_2ws(WSHDR *ws,char *str,unsigned int size);
//arm
