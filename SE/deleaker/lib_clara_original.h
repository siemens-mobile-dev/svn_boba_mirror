...
__swi __arm void  __original_DataBrowserDesc_SetOKSoftKeyText( void* DataBrowserDesc, STRID );
...
__swi __arm void  __original_BookObj_SetFocus( BOOK* book, int focus );

#pragma swi_number=0x133
__swi __arm void  __original_GUIObject_SetTitleText( GUI*, STRID );
...
__swi __arm char  __original_GUIonMessage_SetMenuItemText( GUI_MESSAGE* msg, STRID );

#pragma swi_number=0x139
__swi __arm char  __original_GUIonMessage_SetMenuItemSecondLineText( GUI_MESSAGE* msg, STRID );

#pragma swi_number=0x13A
__swi __arm char  __original_GUIonMessage_SetMenuItemInfoText( GUI_MESSAGE* msg, STRID );

#pragma swi_number=0x13B
__swi __arm char  __original_GUIonMessage_SetMenuItemUnavailableText( GUI_MESSAGE* msg, STRID );

#pragma swi_number=0x13C
__swi __arm void  __original_GUIonMessage_SetMenuItemIcon( GUI_MESSAGE* msg, int align, wchar_t iconID );
...
__swi __arm void  __original_OneOfMany_SetTexts( GUI_ONEOFMANY*, STRID* strids, int Count );

#pragma swi_number=0x149
__swi __arm int  __original_OneOfMany_GetSelected( GUI_ONEOFMANY* );

#pragma swi_number=0x14A
__swi __arm void  __original_StatusIndication_Item8_SetText( STRID );

#pragma swi_number=0x14B
__swi __arm void  __original_GUIObject_SoftKeys_SetAction( GUI*, u16 actionID, void (*proc)( BOOK*, GUI* ) );

#pragma swi_number=0x14C
__swi __arm void  __original_GUIObject_SoftKeys_SetText( GUI*, u16 actionID, STRID );

#pragma swi_number=0x14D
__swi __arm void  __original_GUIObject_SoftKeys_SetEnable( GUI*, u16 actionID, int ena );

#pragma swi_number=0x14E
__swi __arm void  __original_GUIObject_SoftKeys_AddErrorStr( GUI*, u16 actionID, STRID );

#pragma swi_number=0x14F
__swi __arm void  __original_GUIObject_SoftKeys_RemoveItem( GUI*, u16 actionID );

#pragma swi_number=0x150
__swi __arm void  __original_GUIObject_SoftKeys_SetVisible( GUI*, u16 actionID, int visible );
...
__swi __arm STRID  __original_int2strID( int num );

#pragma swi_number=0x15D
__swi __arm STRID  __original_Str2ID( const void* wstr, int flag, int len );

#ifdef __cplusplus
#pragma swi_number=0x15E
__swi __arm void  __original_StrID2Str( STRID, char* str, int maxlen, int null = 0 );
#else
#pragma swi_number=0x15E
__swi __arm void  __original_StrID2Str( STRID, char* str, int maxlen, int null );
#endif

#pragma swi_number=0x15F
__swi __arm int  __original_TextID2wstr( STRID, wchar_t* dest, int maxlen );

#pragma swi_number=0x160
__swi __arm int  __original_TextGetLength( STRID );

#pragma swi_number=0x161
__swi __arm void  __original_TextFree( STRID );
...
__swi __arm int  __original_AB_GETNBROFITEMS( int get_from, int unk_0 );
...
__swi __arm int  __original_Gif2ID( u16 IMAGEHANDLE, const wchar_t* path, const wchar_t* fname, wchar_t* ID );

#pragma swi_number=0x16D
__swi __arm int  __original_REQUEST_IMAGEHANDLER_INTERNAL_GETHANDLE( const int* sync, u16* IMAGEHANDLE, char* unk );
...
__swi __arm void  __original_BookObj_Hide( BOOK* book, int display_type );

#pragma swi_number=0x172
__swi __arm void  __original_BookObj_Show( BOOK* book, int display_type );
...
__swi __arm PROCESS  __original_create_process( int proc_type, char* name, OSENTRYPOINT* entrypoint, OSADDRESS stack_size, OSPRIORITY priority, OSTIME timeslice, PROCESS pid_block, void* redir_table, OSVECTOR vector, OSUSER user );
...
__swi __arm void*  __original_CreateMessage( int size, int ev, char* name );
#pragma swi_number=0x1A2
__swi __arm void  __original_SendMessage( void** signal, int PID );
#pragma swi_number=0x1A3
__swi __arm void*  __original_WaitMessage( void* SIGSEL );
#pragma swi_number=0x1A4
__swi __arm int  __original_FreeMessage( void** Mess );
#pragma swi_number=0x1A5
__swi __arm void  __original_SendDispatchMessage( int id, int unk_zero, int size, void* mess );
...
__swi __arm void  __original_GUIObject_SoftKeys_SetInfoText( GUI*, u16 actionID, STRID );
...
__swi __arm void  __original_TabMenuBar_SetTabIcon( GUI_TABMENUBAR*, int tab, wchar_t icon, int for_state );
#pragma swi_number=0x1CE
__swi __arm GUI*  __original_GUIObject_Destroy( GUI* );
#pragma swi_number=0x1CF
__swi __arm void  __original_GUIInput_SetIcon( GUI* , wchar_t icon );

#pragma swi_number=0x1D0
__swi __arm int  __original_StringInput_GetStringAndLen( GUI*, wchar_t**, u16* );

#pragma swi_number=0x81D1
__swi __arm PAudioControl*  __original_GetAudioControlPtr( );
...
__swi __arm void  __original_NOfMany_SetTexts( GUI_NOFMANY*, STRID* strids, int items_count );
...
__swi __arm PAudioControl  __original_AudioControl_Init( );
...
__swi __arm WINDOW*  __original_DispObject_GetWindow( DISP_OBJ* );
...
__swi __arm void  __original_VCALL_SetNameIcon( void* vc, wchar_t icon );
...
__swi __arm C_INTERFACE*  __original_Window_GetComponentInterface( WINDOW* );
...
__swi __arm STRID  __original_AB_NAME_ITEM2StrID( AB_STR_ITEM* ab_name );
#pragma swi_number=0x214
__swi __arm STRID  __original_AB_NUM_ITEM2StrID( AB_NUM_ITEM* ab_num_item );
#pragma swi_number=0x215
__swi __arm int  __original_GetABRecNum( AB_GET_STRUCT* );
#pragma swi_number=0x8216
__swi __arm AB_ITEM_DESC*  __original_get_AB_ITEMS_DESC( );
...
__swi __arm void  __original_GUIonMessage_SetItemAsSubitem( GUI_MESSAGE* msg, int unk, int n_sub_items );
#pragma swi_number=0x245
__swi __arm void  __original_GUIonMessage_SetSubitemText( GUI_MESSAGE* msg, STRID );
#pragma swi_number=0x246
__swi __arm int  __original_GUIonMessage_GetCreatedSubItemParentIndex( GUI_MESSAGE* msg );
...
__swi __arm int  __original_GUIonMessage_GetCurrentSubItem( GUI_MESSAGE* msg );
#pragma swi_number=0x253
__swi __arm int  __original_GUIonMessage_GetCurrentItemIndex( GUI_MESSAGE* msg );
...
__swi __arm int  __original_MessageBox( STRID header_text, STRID message_text, wchar_t IconID, int style, int time, BOOK* book );
...
__swi __arm void  __original_GUIonMessage_SetItemDisabled( GUI_MESSAGE* msg, int Disabled );
#pragma swi_number=0x283
__swi __arm int  __original_REQUEST_IMAGEHANDLER_INTERNAL_REGISTER( const int* sync, u16 ImageHandle, wchar_t* path, wchar_t* fname, int unk, wchar_t* ImageID, char* error );
#pragma swi_number=0x284
__swi __arm int  __original_REQUEST_IMAGEHANDLER_INTERNAL_UNREGISTER( const int* sync, u16 ImageHandle, u16*, u16*, wchar_t ImageID, int unk_1, char* error );
...
__swi __arm int  __original_GetImageWidth( wchar_t ImageID );
#pragma swi_number=0x294
__swi __arm int  __original_GetImageHeight( wchar_t ImageID );
...
__swi __arm int  __original_FSX_isNameInvalid( wchar_t* name );
...
__swi __arm int*  __original_GetFontCount( );
...
__swi __arm void  __original_BookObj_SoftKeys_SetAction( BOOK* book, int actionID, void (*proc)( BOOK*, GUI* ) );
#pragma swi_number=0x2C3
__swi __arm void  __original_BookObj_SoftKeys_SetText( BOOK* book, int actionID, STRID );
...
__swi __arm void  __original_Feedback_SetTextExtended( GUI_FEEDBACK*, STRID text, int where );
...
__swi __arm STRID  __original_KeyCode2Name( int key_code );

#pragma swi_number=0x2CC
__swi __arm int  __original_ImageID_Get( const wchar_t* fpath, const wchar_t* fname, wchar_t* imageID );
#pragma swi_number=0x2CD
__swi __arm void  __original_ImageID_Free( wchar_t imageID );
...
__swi __arm STRID  __original_PNUM2Name( void* pnum, int isIconNeeded, int only_full_number_flag );
...
__swi __arm int  __original_Disp_GetStrIdWidth( STRID, int len );
...
__swi __arm int  __original_ImageID_GetIndirect( void* buf_image, int size, int __NULL, wchar_t* image_type, wchar_t* imageID );
...
__swi __arm int  __original_JavaApp_LogoImageID_Get( wchar_t* fullpath, wchar_t* imageID );

#pragma swi_number=0x30D
__swi __arm GUI*  __original_CreateProgressBar( BOOK* book, int display );
#pragma swi_number=0x30E
__swi __arm void  __original_ProgressBar_SetText( GUI*, STRID text );
#pragma swi_number=0x30F
__swi __arm void  __original_ProgressBar_SetIcon( GUI*, u16 icon_id );
#pragma swi_number=0x310
__swi __arm void  __original_ProgressBar_SetPercentValue( GUI*, int value );
#pragma swi_number=0x311
__swi __arm void  __original_ProgressBar_SetBarDisabled( GUI*, int disabled );

#pragma swi_number=0x312
__swi __arm void  __original_StringInput_DispObject_SetText( DISP_OBJ*, STRID );

#pragma swi_number=0x313
__swi __arm void  __original_GUIObject_SetTitleBackgroundImage( GUI*, wchar_t imageID );
#pragma swi_number=0x314
__swi __arm void  __original_GUIObject_SetTitleIcon( GUI*, wchar_t imageID );
#pragma swi_number=0x315
__swi __arm void  __original_GUIObject_SetCursorImage( GUI*, wchar_t imageID );
#pragma swi_number=0x316
__swi __arm void  __original_GUIObject_SetBackgroundImage( GUI*, wchar_t imageID );
...
__swi __arm void  __original_SetTrayIcon( wchar_t iconID, char mode );
...
__swi __arm void  __original_MediaPlayer_SoftKeys_SetText( GUI* player_gui, int actionID, STRID );
#pragma swi_number=0x36A
__swi __arm void  __original_MediaPlayer_SoftKeys_SetAction( GUI* player_gui, int actionID, void (*proc)( BOOK*, GUI* ) );
...
__swi __arm int  __original_REQUEST_PROFILE_GETPROFILENAME( const int* sync, int unk, STRID_DATA*, char* error );
...
__swi __arm int  __original_ListMenu_SetItemIcon( GUI_LIST*, int Item, wchar_t unk_FFFF, int mode, wchar_t ImageID );
...
__swi __arm void  __original_DispObject_SetCursorImage( DISP_OBJ*, wchar_t imageID );
