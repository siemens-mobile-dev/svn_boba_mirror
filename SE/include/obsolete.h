...
DEPRECATE(void,List2lineSetAsSubitem,GUIonMessage_SetItemAsSubitem)
DEPRECATE(void,List2lineSubitemAddText,GUIonMessage_SetSubitemText)
DEPRECATE(int,List2LineGetCurrentIndex,GUIonMessage_GetCurrentSubItem)
...
DEPRECATE(int,DISP_OBJ_GetWindowWidth,DispObject_GetWindowWidth)
...
DEPRECATE(int,GUIonMessage_GetCreatedSubItemParrentIndex,GUIonMessage_GetCreatedSubItemParentIndex)
...
#define List2lineSetAsSubitem GUIonMessage_SetItemAsSubitem
#define List2lineSubitemAddText GUIonMessage_SetSubitemText
#define List2LineGetCurrentIndex GUIonMessage_GetCurrentSubItem
...
#define GUIonMessage_GetCreatedSubItemParrentIndex GUIonMessage_GetCreatedSubItemParentIndex
