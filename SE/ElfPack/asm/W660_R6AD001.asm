...
TABMENUBAR_NAME EQU 0x45BC92A0
...
a       EQU     b
        ...
        RSEG  CODE
        defadr   STANDBY_RET,0x453DA720+1
        defadr   DB_PATCH_RET,0x44FD1818+1
        defadr   DB_EXT_RET,0x44FD1604+1
        defadr   DB_PATCH3_RET,0x44FD14A4+1
        defadr   DB_PATCH4_RET,0x44FD1E70+1
        defadr   MESS_HOOK_RET,0x448C2C24+1
	defadr   KEY_HOOK_REPEAT_RETUN,0x4546F58A+1
	defadr   KEY_HOOK_TIMER_RETUN,0x4546F5E6+1
	defadr   KEY_HOOK_TIMER_RETUN_NE,0x4546F5B0+1

        defadr  memalloc,0x44E64BF0+1
        defadr  memfree,0x44E64C1C+1
