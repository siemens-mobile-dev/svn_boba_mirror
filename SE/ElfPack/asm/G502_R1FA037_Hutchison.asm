...
a       EQU     b
        ...
        RSEG  CODE
        defadr	STANDBY_RET,0x1160F368+1
        defadr	DB_PATCH_RET,0x1100CC24+1
        defadr	DB_EXT_RET,0x1100CA30+1
        defadr	DB_PATCH3_RET,0x1100C8F0+1
        defadr	DB_PATCH4_RET,0x1100D400+1
        defadr	DB_PATCH5_RET,0x1100CA7C+1
        defadr	DB_PATCH6_RET,0x1100CAB0+1
        defadr	MESS_HOOK_RET,0x107626E4+1
        defadr	PAGE_ACTION_RET,0x11602B54+1
        defadr	memalloc,0x107ADAF4+1
        defadr	memfree,0x107ADB04+1
