...
#define pKBD 0x4C057C48
#define EXT_TABLE 0x444E9A98

#define STR_START 0x0B9D
#define STR_APPLICATION 0x0342
#define STR_Saved_in_Applications_on_Memory_Stick 0x0FEF
#define STR_Saved_in_Applications_in_phone_memory 0x0FEE

#define ELF_SMALL_ICON 0xE5AC

#define ROOT_APP 0x4C2EE860
#define PID_MMI 0x100E5							//
#define HELPER_SIG 0x6FF0
#define RAM_BASE (0x4C03F018)
...
//Webpage_Run_Page
#define ELF_RUN_PAGE_EV_0x10 0x455B27DD
#define ELF_RUN_PAGE_EV_0x0F 0x455B27DD
#define ELF_RUN_PAGE_EV_0x11 0x455B27E5
#define ELF_RUN_PAGE_EV_0x06 0x455B2879
//ext_mp3
