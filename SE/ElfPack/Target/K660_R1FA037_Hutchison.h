...
#define PATH_AUDIO_EXT 0x11988B28
#define PATH_IMAGE_INT 0x1198B928
#define PATH_IMAGE_EXT 0x11988B94
#define PATH_VIDEO_INT 0x1198BB6C
#define PATH_VIDEO_EXT 0x11988C0C
#define PATH_THEME_INT 0x1198BAD8
#define PATH_THEME_EXT 0x11988BF4
#define PATH_OTHER_INT 0x1198B9A8
#define PATH_OTHER_EXT 0x11988BDC
