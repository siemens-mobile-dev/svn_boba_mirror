...
#define PATH_AUDIO_INT (wchar_t*)0x459B81DC
#define PATH_AUDIO_EXT (wchar_t*)0x456EE2E8
#define PATH_IMAGE_INT (wchar_t*)0x456EE048
#define PATH_IMAGE_EXT (wchar_t*)0x456EE354
#define PATH_VIDEO_INT (wchar_t*)0x456EE0F4
#define PATH_VIDEO_EXT (wchar_t*)0x456EE3F8
#define PATH_THEME_INT (wchar_t*)0x456EE0D4
#define PATH_THEME_EXT (wchar_t*)0x456EE3E0
#define PATH_OTHER_INT (wchar_t*)0x456EE06C
#define PATH_OTHER_EXT (wchar_t*)0x456EE3AC
