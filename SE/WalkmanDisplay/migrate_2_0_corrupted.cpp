...
int migrate_from_2_0corrupted_to_2_1(CFG_2_0_corrupted *oldcfg, CFG_2_1 *cfg)
{
  ...
  memcpy(cfg->trackn_mask, oldcfg->trackn_mask,49);
  ...
  memcpy(cfg->tracks_mask, oldcfg->tracks_mask,49);
  ...
  memcpy(cfg->ctime_mask, oldcfg->ctime_mask,49);
  ...
  memcpy(cfg->ftime_mask, oldcfg->ftime_mask,49);
  ...
  memcpy(cfg->ltime_mask, oldcfg->ltime_mask,49);
  ...
  memcpy(cfg->bitrate_mask, oldcfg->bitrate_mask,49);
  memcpy(cfg->bitrate_vbr, oldcfg->bitrate_vbr,49);
  ...
  memcpy(cfg->freq_mask, oldcfg->freq_mask,49);
  ...
  memcpy(cfg->trackn_mask_h, oldcfg->trackn_mask_h,49);
  ...
  memcpy(cfg->tracks_mask_h, oldcfg->tracks_mask_h,49);
  ...
  memcpy(cfg->ctime_mask_h, oldcfg->ctime_mask_h,49);
  ...
  memcpy(cfg->ftime_mask_h, oldcfg->ftime_mask_h,49);
  ...
  memcpy(cfg->ltime_mask_h, oldcfg->ltime_mask_h,49);
  ...
  memcpy(cfg->bitrate_mask_h, oldcfg->bitrate_mask_h,49);
  memcpy(cfg->bitrate_vbr_h, oldcfg->bitrate_vbr_h,49);
  ...
  memcpy(cfg->freq_mask_h, oldcfg->freq_mask_h,49);
