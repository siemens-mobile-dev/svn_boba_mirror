...
begin
  ...
  *)
  ...
  if (Value and S_DND) = S_DND then
    ...
    Result := S_NA
  else if (Value and S_OCCUPIED) = S_OCCUPIED then  // updated by eraser 8.7.03
    Result := S_OCCUPIED
  else if (Value and S_DND) = S_DND then  // updated by eraser 8.7.03
    Result := S_DND
    ...
    Result := S_FFC
  else if (Value and S_NA) = S_NA then  // updated by eraser 8.7.03
    Result := S_NA
