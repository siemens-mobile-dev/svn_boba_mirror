  ...
  chr = (*(UTF8_str+i));
	...
	if (chr<0xe0) {
	    // cx, dx
             ...
             else if ((chr == 0xD0)&&(chr2 == 0x9E)){*(tmp_out+lastchar) = 0xA2;}//ў
             ...
             else if ((chr == 0xD1)&&(chr2 == 0x8E)){*(tmp_out+lastchar) = 0xA1;}//Ў
             else if ((chr == 0xD2)&&(chr2 == 0x91)){*(tmp_out+lastchar) = 0xE3;}//ґ->г
             else if ((chr == 0xD2)&&(chr2 == 0x90)){*(tmp_out+lastchar) = 0xC3;}//Ґ->Г
//             else if ((chr == 0xD2)&&(chr2 == 0x91)){*(tmp_out+lastchar) = 0xB4;}//ґ
//             else if ((chr == 0xD2)&&(chr2 == 0x90)){*(tmp_out+lastchar) = 0xA5;}//Ґ
             else
          {
	    char test1 = (chr & 0x1f)<<6;
            char test2 = chr2 & 0x3f;
