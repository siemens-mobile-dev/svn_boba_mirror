...
main:
	...
	LDREQH	R0,[LR]			; Зацепляем второе слово (длинный номер)
	ADDEQ	LR,LR,#3		; Устанавливаем мл. бит адреса возврата и пропускаем DW
	ADDNE	LR,LR,#1		; Если короткий, то достаточно только бит0
