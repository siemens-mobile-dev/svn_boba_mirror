...
__swi __arm void DrawLine(int x,int y,int x2,int y2,int type,int *pen);
//thumb
//pattern=??,B5,04,1C,01,20,??,??,??,??,FF,20

#pragma swi_number=0x1B4
__swi __arm void DrawRectangle(int x,int y,int x2,int y2,int flags,int *pen,int *brush);
//thumb
