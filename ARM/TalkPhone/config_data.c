...
__root const CFG_HDR cfghdr13={CFG_UINT,"Вызов по клавише",0,65535};
...
__root const CFG_HDR cfghdr2={CFG_TIME,"Начиная с",0,0};
__root const TTime TimeFrom={8,0};

__root const CFG_HDR cfghdr3={CFG_TIME,"Заканчивая",0,0};
__root const TTime TimeTo={22,0};

__root const CFG_HDR cfghdr4={CFG_UINT,"Когда минуты=",0,59};
...
__root const CFG_HDR cfghdr5={CFG_UINT,"Громкость",0,6};
__root const unsigned int volume=6;

__root const CFG_HDR cfghdr8={CFG_STR_UTF8,"Путь к папке с *.wav",0,127};
__root const char folder_path[128]=DEFAULT_DISK ":\\ZBin\\sndElfs\\TalkPhone\\";

//__root const CFG_HDR cfghdr12 = {CFG_UINT, "Доп. пауза (тиков)", 0, 100};
...
__root const CFG_HDR cfghdr6={CFG_CBOX,"Показывать иконку",0,2};
...
__root const CFG_HDR cfghdr9={CFG_CBOX,"Использовать вибру",0,2};
__root const int Is_Vibra_Enabled=1;
__root const CFG_CBOX_ITEM cfgcbox4[2]={"Нет","Да"};

__root const CFG_HDR cfghdr10 = {CFG_UINT, "Кол-во вибраций", 0, 10};
__root const unsigned int vibra_count = 4;

__root const CFG_HDR cfghdr11 = {CFG_UINT, "Мощность вибраций", 0, 100};
